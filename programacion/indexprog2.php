  ...
  <div class="card-body">
    <div>
      ...
      <table class="table-striped">
        <thead>
          <tr>
            <th class="text-center" colspan="2">SALA 1</th>
            <th class="text-center" colspan="2">SALA 2</th>
            <th class="text-center" colspan="2">SALA 3</th>
                ...
                <div class="card-body">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <th>12/12/12</th>
                      <th>12/12/12</th>
                      <th><button class="btn-sm btn-outline-primary"></button> </th>
                      <th><button class="btn-sm btn-outline-primary"></button> </th>
                      <th><button class="btn-sm btn-outline-primary"></button> </th>
                      <th><button class="btn-sm btn-outline-primary"></button> </th>
                    </tr>                                        
